...
const projects = [
  {
    ...
    year: '2025',
    description: 'Full-stack RAG + Agentic AI platform solving Sri Lanka\'s degree program selection crisis. Vector database retrieval, LLM generation, and multi-step reasoning to match students with optimal degree pathways.',
  ...
  },
  {
    ...
    year: '2024',
    description: 'Reproduction of the foundational Bromley et al. (1993) Siamese Neural Network paper for face verification. Contrastive learning, twin-network embeddings, and modern TensorFlow implementation from first principles.',
  ...
  },
  {
    ...
    category: 'NLP · LSTM',
    year: '2024',
    description: 'LSTM-based language model predicting next word in text sequences. End-to-end NLP pipeline with tokenization, vocabulary mapping, and probability distribution over full vocabulary for auto-completion.',
  ...
  },
  {
    ...
    year: '2024',
    description: 'Neural network trained on MNIST dataset using PyTorch. Handwritten digit classification from first principles — data loading, model architecture, training loop, and evaluation.',
  ...
  },
  {
    ...
    year: '2024',
    description: 'Text sentiment classification system analyzing emotional tone in input data. Feature extraction, model training, and inference pipeline for positive/negative/neutral prediction.',
    stack: 'PYTHON · NLP · ML',
    id: '05',
  ...
  },
  {
    ...
    year: '2024',
    description: 'Self-learning car using neural networks in JavaScript. Autonomous agent trained to navigate environments through reinforcement learning and sensor-based decision making.',
...
const achievements = [
  ...
  },
  {
    ...
    detail: '"OS-Level Contextual AI Assistant for Reducing Context Switching in Novice Programming Workflows" — under review',
  },
]
...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    document.body.style.background = 'linear-gradient(180deg, #f5f5f8 0%, #e0e0ea 20%, #b8b8c8 45%, #505060 75%, #0a0a12 100%)'
    return () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden">
      {/* Background Three.js blob — jiggling, no click response */}
      <BackgroundBlob />
      ...
      >
        ...
        >
          <span
            ...
            style={{
              background: menuOpen ? '#2a8a6e' : '#4a4a58',
      ...
      <section
        id="hero"
        data-section
        className="relative min-h-screen flex flex-col justify-center items-start px-6 lg:px-16 pt-20 lg:pt-24 pb-12"
      >
        <div className="max-w-4xl relative z-10">
          <div
            className="font-mono text-xs uppercase mb-8 flex items-center gap-4"
          ...
          <h1
            className="font-orbitron uppercase font-black leading-none mb-6"
            style={{
          ...
          >
            UDULA
            <br />
            <span style={{ color: '#2a8a6e' }}>HARITH</span>
          </h1>

          <p
            className="font-rajdhani text-lg lg:text-xl font-light max-w-lg mb-10"
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(90deg, transparent 0%, rgba(45, 212, 168, 0.2) 50%, transparent 100%)',
          }}
        />
      </section>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-12 lg:mb-20 gap-4">
            <div>
              ...
              <h2
                className="font-orbitron uppercase font-bold"
                style={{
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
            {projects.map((project, i) => (
              ...
              >
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-6">
                    <span
                      ...
                      style={{ color: '#2a8a6e', letterSpacing: '3px' }}
                    >
                      {project.id}
                    </span>
                    <span
                  ...
                  <h3
                    className="font-orbitron uppercase text-lg lg:text-xl mb-4 leading-tight"
                  ...
                  <p
                    className="font-rajdhani text-sm font-light leading-relaxed mb-4"
                    style={{ color: '#2a2a38' }}
                  >
                    {project.description}
                  </p>
                  ...
                  <span
                    className="font-mono text-xs"
                    style={{ color: '#2a6a4e', letterSpacing: '2px' }}
                  >
                    {project.stack}
                  </span>
                </div>
                ...
                <div
                  className="relative z-10 flex justify-between items-center mt-8 pt-5"
                  style={{ borderTop: '1px solid rgba(45, 212, 168, 0.1)' }}
                >
                  <span
                    className="font-mono text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-500"
      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 relative z-10">
          <div className="lg:col-span-5">
            ...
            <h2
              className="font-orbitron uppercase font-bold mb-10"
              style={{
            ...
            <div className="space-y-6 mb-10">
              <p
                className="font-rajdhani text-base lg:text-lg font-light leading-relaxed"
                style={{ color: '#1a1a24' }}
              >
            ...
            >
              ...
              {achievements.map((ach, i) => (
                <div key={i} className="mb-3 last:mb-0">
                  ...
                  <div
                    className="font-rajdhani text-sm font-light mt-1"
                    style={{ color: '#2a2a38' }}
                  >
                    {ach.detail}
                  </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div
                  className="font-rajdhani text-sm font-light"
                  style={{ color: '#2a2a38' }}
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {capabilities.map((skill, i) => (
                <div
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = 'rgba(45, 212, 168, 0.1)'
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                {[
                  ...
                  <div key={metric.label} className="text-center">
                    <div
                      className="font-orbitron text-2xl lg:text-3xl font-bold mb-1"
                      style={{ color: '#1a1a24' }}
                    >
                      {metric.value}
                    </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div
            className="font-mono text-xs uppercase mb-6 flex justify-center items-center gap-4"
            style={{ color: '#4a4a58', letterSpacing: '5px' }}
          >
            <span className="inline-block w-12 h-px" style={{ background: '#2a8a6e' }} />
            <span className="hidden sm:inline">OBSERVATION LOG CLOSED // INITIATE CONTACT</span><span className="sm:hidden">INITIATE CONTACT</span>
            <span className="inline-block w-12 h-px" style={{ background: '#2a8a6e' }} />
          </div>

          <h2
            className="font-orbitron uppercase font-black mb-8"
            style={{
          ...
          <div
            className="mb-14 mx-auto max-w-lg"
            style={{
              background: 'rgba(255, 255, 255, 0.35)',
              backdropFilter: 'blur(12px)',
          ...
          >
            <p
              className="font-rajdhani text-lg lg:text-xl font-light leading-relaxed"
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-12">
            <a
              href="mailto:udulaharith@gmail.com"
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = 'transparent'
                e.currentTarget.style.color = '#1a1a24'
                e.currentTarget.style.boxShadow = '0 0 30px rgba(45, 212, 168, 0.15)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = '#1a1a24'
                e.currentTarget.style.color = '#f5f5f8'
            ...
            <a
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = 'rgba(45, 212, 168, 0.5)'
                e.currentTarget.style.color = '#2a8a6e'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = 'rgba(45, 212, 168, 0.2)'
                e.currentTarget.style.color = '#2a2a38'
              }}
            >
              GITHUB →
            </a>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8">
            <a
              href="https://www.linkedin.com/in/udula-harith-sadishan-703b41321"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <footer
        ...
        style={{
          borderTop: '1px solid rgba(45, 212, 168, 0.1)',
        }}
      >
        <span
          className="font-orbitron text-xs uppercase"
          style={{ color: '#4a4a58', letterSpacing: '4px' }}
        >
          UDULA HARITH // 2025
        </span>
        <span
          ...
          style={{ color: '#4a4a58', letterSpacing: '4px' }}
        >
          AI ENGINEER · DEEP LEARNING · AGENTIC SYSTEMS        </span>
      </footer>
    </div>
  )
}
